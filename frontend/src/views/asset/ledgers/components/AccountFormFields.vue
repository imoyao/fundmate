<template>
  <div>
    ...
    <!-- 高级设置：费率信息 -->
    <el-collapse v-if="ledgerType === 'stock' || ledgerType === 'fund'" class="mt-4">
      <el-collapse-item title="高级设置（费率）" name="fee">
        <template v-if="ledgerType === 'stock'">
          <el-form-item label="佣金率">
            ...
            />
            <p class="text-xs mt-1" :style="{ color: 'var(--text-tertiary)' }">如万2.5输入 0.00025</p>
          </el-form-item>
        ...
        <template v-if="ledgerType === 'fund'">
          <el-form-item label="申购费折扣">
            ...
            />
            <p class="text-xs mt-1" :style="{ color: 'var(--text-tertiary)' }">0.1 = 1折，0.01 = 0.1折，0 = 免申购费</p>
          </el-form-item>
        </template>
      </el-collapse-item>
    </el-collapse>
