...
| **署名义务** | 「应在软件中特别注明使用了 MiSans 字体」 | /about 页面底部（品牌故事致谢区） 加 Mi Sans 署名 |
| **禁止改编** | 不得对字体外观改编 / 二次开发 / 单独分发字体文件 | 子集化属「使用」合规；**不得修改字形轮廓** |
| **来源记录** | — | 存档授权页：[hyperos.mi.com/font/faq](https://hyperos.mi.com/font/faq) |

> **署名位置决策**：页脚是全站唯一统一曝光位，符合法律要求且不干扰转化主线。若页脚空间紧张，可缩为「字体：MiSans（小米）」并添加超链至授权页。
...
| **3. 署名文案最终位置？** | **首页页脚**（靠近版权区）。文案：“界面中文由 MiSans 字体渲染，版权归小米科技。” |
