...
| `frontend-holding-import-plan-2026-08-16.md` | **前端持仓导入设计（#1013，待确认）**：导入向导新增「导入持仓快照」模式（后端 PR #1021 已合入）；入口第四张卡片、3 步流程（上传/预览/结果）、独立 `useHoldingImport.ts` composable 状态隔离、组件改动清单、design.md 逐条对照清单、4 个待确认决策点 |
