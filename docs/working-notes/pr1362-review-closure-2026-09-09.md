...
| 代码 | 名称 | 近 12 月 | 全量落库 | 价格模式 | 原清单 |
|---|---|---|---|---|---|
| 881001.WI | 万得全 A | 242 | 6465（2000-01-04 起） | anchored | 已有 |
| 881003.WI | 万得全 A(除金融、石油石化) | 239 | 6458（2000-01-04 起） | anchored | **漏抓→已补** |
| 881007.WI | 万得 300 除金融 | 242 | 4074（2009-11-30 起） | anchored | **漏抓→已补** |
...
- **估值分位未落库**：`index-basic` 返回的 `pe_pct`（韭圈儿页面「近 5 年市盈率百分位」）未存 `IndexDaily`，如需展示属新需求（建议单开 issue）。
