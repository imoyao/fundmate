...
BASELINE: dict[str, dict[str, int]] = {
    ...
    "backend/app/domains/users/views.py": {"lines": 115, "orm_queries": 4, "commits": 1, "max_func": 38},
    "backend/app/domains/utils/views.py": {"lines": 126, "orm_queries": 0, "commits": 0, "max_func": 38},
    "backend/app/domains/watchlist/views.py": {"lines": 712, "orm_queries": 14, "commits": 14, "max_func": 104},
}
