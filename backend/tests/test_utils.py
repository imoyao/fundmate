...
@pytest.mark.parametrize(
    'number_of_days,expected', [(1, (0, 0, 1)), (365, (1, 0, 0)), (365, (1, 0, 0)), (366, (1, 0, 1)), (396, (1, 1, 1))]
)
...
@pytest.mark.parametrize(
    'lite_dict,big_dict,expected',
    [
        ({'a': '2', 'b': '3'}, {'a': '2', 'b': '3', 'c': '4'}, True),
        ({'a': '2', 'b': '3'}, {'a': '2', 'b': '3'}, True),
        ({'a': 2, 'b': 3}, {'a': '2', 'b': '3'}, False),
        (
            {
                'redeem_rule_id': 24,
                'fund_id': 103,
