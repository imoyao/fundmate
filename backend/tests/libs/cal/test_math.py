#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Created by Administrator at 2021/1/21 23:14
from datetime import datetime

import pytest
from pytest import approx

from backend.fundmate.libs.cal.math import cleanXirr, xirr, xnpv
...
@pytest.mark.parametrize("valuesPerDateString,expected", [
    ...
    ({'2017-12-16': -2236.3994659663, '2017-12-26': -47.3417585212, '2017-12-29': -46.52619316339632,
      '2017-12-31': 10424.74612565936, '2017-12-20': -13.077972551952}, 1.2238535289956518e+16),
