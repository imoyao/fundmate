...
class TestXIRRNew:
    def test_xirr(self):
        x = rr.XIRR()
        assert x.xirr(
            [-18990, -23320, 49490], [date(2016, 2, 5), date(2018, 1, 26), date(2018, 6, 5)]
        ) == pytest.approx(0.12801613991037272, 0.00000000001)


class TestXIRR:
    @pytest.mark.parametrize(
        'values_per_date_string,expected',
        [
...
class TestXNPV:
    @pytest.mark.parametrize(
        'values_per_date_string,rate,expected',
        [
