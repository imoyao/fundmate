    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                '163406',
                {
                    'op': [{'name': '基金托管费', 'value': '0.2500'}, {'name': '基金管理费', 'value': '1.5000'}],
                    'purchase': [
                        {'end_quota': 500000.0, 'rate': 1.2, 'start_quota': 0},
                        {'end_quota': 2000000.0, 'rate': 0.8, 'start_quota': 500000.0},
                        {'end_quota': 5000000.0, 'rate': 0.5, 'start_quota': 2000000.0},
                        {'end_quota': None, 'fee_amount': 1000.0, 'start_quota': 5000000.0},
                    ],
                    'redeem': [
                        {'end_day': 7, 'rate': 1.5, 'start_day': 0},
                        {'end_day': 365, 'rate': 0.5, 'start_day': 7},
                        {'end_day': 730, 'rate': 0.25, 'start_day': 365},
            ...
            (
                ...
                {
                    'op': [
                        {'name': '销售服务费', 'value': '0.3500'},
                        {'name': '基金托管费', 'value': '0.1000'},
                        {'name': '基金管理费', 'value': '0.3000'},
                    ],
                    'purchase': [{'end_quota': None, 'fee_amount': 0.0, 'start_quota': 0}],
                    'redeem': [
                        {'end_day': 7, 'rate': 1.5, 'start_day': 0},
                        {'end_day': 31, 'rate': 0.1, 'start_day': 7},
                        {'end_day': None, 'rate': 0.0, 'start_day': 31},
                    ],
                },
            ),
            (
                '000906',
                {
                    'op': [{'name': '基金托管费', 'value': '0.3500'}, {'name': '基金管理费', 'value': '1.8000'}],
                    'purchase': [
            ...
            (
                ...
                {
                    'op': [
                        {'name': '销售服务费', 'value': '0.0000'},
                        {'name': '基金托管费', 'value': '0.2500'},
                        {'name': '基金管理费', 'value': '0.6000'},
                    ],
                    'purchase': [
                        {'end_quota': 500000.0, 'rate': 1.2, 'start_quota': 0},
                    ...
                    'redeem': [
                        ...
                        {'end_day': 90, 'rate': 0.5, 'start_day': 30},
                        {'end_day': 180, 'rate': 0.5, 'start_day': 90},
                        {'end_day': 366, 'rate': 0.1, 'start_day': 180},
                        {'end_day': 730, 'rate': 0.05, 'start_day': 366},
                        {'end_day': None, 'rate': 0.0, 'start_day': 730},
                    ],
                },
            ),
            (
                '003663',
                {
                    'op': [{'name': '基金托管费', 'value': '0.2000'}, {'name': '基金管理费', 'value': '0.7000'}],
                    'purchase': [
