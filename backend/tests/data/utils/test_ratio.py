...
class TestFundFeeRatio:
    ...
    @pytest.mark.parametrize(
        'redeem_rate,time_key,rate_key,expected',
        [
            (
                [
                    {'money': '', 'time': '持有期限 < 7天', 'source': '', 'rate': '1.50%'},
                    {'money': '', 'time': '7天 ≤ 持有期限 < 30天', 'source': '', 'rate': '0.75%'},
                    {'money': '', 'time': '30天 ≤ 持有期限 < 6个月', 'source': '', 'rate': '0.50%'},
                    {'money': '', 'time': '持有期限 ≥ 6个月', 'source': '', 'rate': '0.00%'},
                ],
                'time',
                'rate',
                [
