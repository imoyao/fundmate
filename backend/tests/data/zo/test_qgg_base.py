...
class TestFundFollowAip:
    ...
    @pytest.mark.parametrize('endpoint', FollowAip.ENDPOINT_LIST)
                    ...
                    'thisWeekIndustry': [
                        {
                            ...
                            'topThreeFundNameList': ['易方达国防军工混合', '交银启明混合A', '华安大安全C'],
                            'fundNameList': [
                                '易方达国防军工混合',
                                '交银启明混合A',
                                '华安大安全C',
                        ...
                        },
                        {
                            ...
                            'topThreeFundNameList': ['富国转型机遇混合', '长城中小盘', '海富通改革驱动混合'],
                            'fundNameList': [
                                '富国转型机遇混合',
                                '长城中小盘',
                                '海富通改革驱动混合',
                        ...
                        },
                        {
                            ...
                            'topThreeFundNameList': ['金鹰改革', '银华心怡', '中欧明睿新起点'],
                            'fundNameList': [
                                '金鹰改革',
                                '银华心怡',
                                '中欧明睿新起点',
                    ...
                    'otherIndustry': [
                        {
                            ...
                            'topThreeFundNameList': ['工银医药A', '中欧医疗创新A', '交银医药创新混合'],
                            'fundNameList': [
                                '工银医药A',
                                '中欧医疗创新A',
                                '交银医药创新混合',
                        ...
                        },
                        {
                            ...
                            'topThreeFundNameList': ['易方达国防军工混合', '华安制造A', '汇丰低碳'],
                            'fundNameList': [
                                '易方达国防军工混合',
                                '华安制造A',
                                '汇丰低碳',
                        ...
                        },
                        {
                            ...
                            'topThreeFundNameList': ['中欧时代智慧A', '南方转型增长', '银华心诚'],
                            'fundNameList': [
                                '中欧时代智慧A',
                                '南方转型增长',
                                '银华心诚',
                    ...
                    'other_industry': [
                        {
                            ...
                            'product_info': {'product_id': '8100000218', 'product_name': '中欧带你投医疗健康'},
                        },
                        {
                            'industry_view': {
                                'industry_name': '中国智造',
                            ...
                            'product_info': {'product_id': '8100000236', 'product_name': '中欧带你投中国智造'},
                        },
                        {
                            'industry_view': {
                                'industry_name': '新消费',
                            ...
                            'product_info': {'product_id': '8100000237', 'product_name': '中欧带你投新消费'},
                        },
                    ],
                    'this_week_industry': [
                        {
                            ...
                            'product_info': {'product_id': '8100000282', 'product_name': '中欧带你投国防军工'},
                        },
                        {
                            'industry_view': {
                                'industry_name': '碳中和',
                            ...
                            'product_info': {'product_id': '8100000192', 'product_name': '中欧带你投碳中和'},
                        },
                        {
                            'industry_view': {
                                'industry_name': '硬科技',
                            ...
                            'product_info': {'product_id': '8100000215', 'product_name': '中欧带你投硬科技'},
                        },
                    ],
                },
            ),
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                {
                    'departureDate': '20221012',
                    'currentWorkDay': '20221014',
                    'endDate': '20221018',
                    'title': '新能源估值及基本面优势明显',
