...
def test_auth_required(app, client):
    ...
    assert rv.json['components']['securitySchemes']['BasicAuth'] == {'scheme': 'Basic', 'type': 'http'}
...
def test_auth_required_at_blueprint_before_request(app, client):
    ...
    assert rv.json['components']['securitySchemes']['BearerAuth'] == {'scheme': 'Bearer', 'type': 'http'}
