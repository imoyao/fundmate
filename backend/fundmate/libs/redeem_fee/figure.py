...
from backend.fundmate.libs.redeem_fee import fl
...
def draw(hold_data, fund_list):
    # [centos matplotlib 中文 显示方框 - 天善智能：专注于商业智能BI和数据分析、大数据领域的垂直社区平台](https://ask.hellobi.com/blog/safa/36786)
    ...
    for code, data in hold_data.items():
        ...
        for a, b in zip(dates, fene):
            ...
            if t != 0:
                ...
                text = '%d\n%s' % (t, date_str)
                plt.text(a, b, text, ha='center', va='bottom', fontsize=12)
