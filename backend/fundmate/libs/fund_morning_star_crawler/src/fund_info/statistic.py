...
class FundStatistic:
    ...
    def all_stock_fund_count(self, *, quarter_index=None, fund_code_pool=None, filter_count=100):
        ...
        results = self.each_query.select_top_10_stock(quarter_index, fund_code_pool)
        code_dict = dict()
            ...
            for index in range(4, len(result), 3):
                ...
                if (key in code_dict and code != None):
                    ...
                    holder_asset = code_dict[key]['holder_asset'] + \
                        holder_asset
                    code_dict[key] = {'count': count, 'holder_asset': holder_asset}
                else:
                    code_dict[key] = {'count': 1, 'holder_asset': holder_asset}
        filer_dict = dict()
    ...
    def select_special_stock_special_quarter_info(self, stock_code, quarter_index=None, fund_code_pool=None):
        ...
        target_stock_dict = {'count': len(result)}
    ...
    def select_fund_pool(self, *, morning_star_rating_5="", morning_star_rating_3="", **args):
        return self.each_query.select_certain_condition_funds(morning_star_rating_5=morning_star_rating_5,
    ...
    def summary_special_funds_stock_detail(self, fund_code_pool, quarter_index=None):
        ...
        for fund_code in fund_code_pool:
            ...
            for index in range(7, len(fund_info), 3):
                ...
                stock_list_industry = [
                    fund_code, fund_name, fund_cat, fund_manager, fund_total_asset, fund_total_portion,
                    fund_ten_portion, stock_code, stock_name, stock_portion, stock_index
                ]
